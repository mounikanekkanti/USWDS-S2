            ...
            <div className="frame-39">
              ...
              <div className="frame-41">
                ...
                <div className="load-more">
                  ...
                  <Icon38 className="icon-141-instance" color="#005EA2" />
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="content-6">
                ...
                <div className="here-s-how-you-know-4">
                  <div className="overlap-group-7">
                    ...
                    <Icon38 className="icon-6" color="#005EA2" />
                  </div>
                </div>
              </div>
            </div>
                  ...
                  <div className="menu-5">
                    ...
                    <div className="group-13">
                      <div className="nav-link-16">
                        <div className="frame-50">
                          <div className="section-7">Release Notes</div>
                        </div>
                      </div>
                    </div>
                    ...
                    <Link className="nav-link-15" to="/02">
                      <div className="frame-50">
                        <div className="section-7">Data Sets</div>
                        <Icon150 className="icon-1" color="#565C65" />
                      </div>
                    </Link>
                    ...
                    <Link className="group-14" to="/03">
                      <div className="nav-link-16">
                        <div className="frame-50">
                          <div className="section-7">Resources</div>
                          <Icon150 className="icon-1" color="#565C65" />
                        </div>
                      </div>
                    </Link>
